...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    id: "awele-godbless",
    quote:
      "God bless you ma. I don't know how you get to know or speak my heart so loudly. Well said ma. More of God's wisdom and grace.",
    name: "Awele",
  },
  {
    id: "lena",
    quote:
      "This is such an intentional way — another wonderful journey with like minds. I'm 100% open to it.",
    name: "Lena",
  },
  {
    id: "maria",
    quote:
      "Thank you, Lady Cyd. This extremely resonates with what I have been seeking for.",
    name: "Maria",
  },
  {
    id: "lilian",
    quote:
      "This course has been everything God has been showing me over the past year. More and more confirmation for me and my assignment. Thank you, Lady Cyd. I am really looking forward to your next coaching programme.",
    name: "Lilian",
  },
];
